...
test.describe('Pomodoro Notifications', () => {
  test('should have notification settings in configuration', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: /Probar sonido/ }).first()).toBeVisible()
  })
  ...
  test('should save notification preferences to localStorage', async ({ page }) => {
    ...
    const audioInput = page.locator('label').filter({ hasText: 'Sonidos de notificación' }).locator('input[type=\"checkbox\"]').first()
    ...
    const notificationInput = page.locator('label').filter({ hasText: 'Habilitar notificaciones' }).locator('input[type=\"checkbox\"]').first()
  ...
  test('should handle notification permission states', async ({ page, context }) => {
    ...
    const notificationCheckbox = page.locator('label').filter({ hasText: 'Habilitar notificaciones' }).locator('input[type=\"checkbox\"]').first()
  ...
  test('should show notification configuration correctly', async ({ page }) => {
    ...
    const notificationContainer = page.locator('label').filter({ hasText: 'Habilitar notificaciones' }).first()
    const audioContainer = page.locator('label').filter({ hasText: 'Sonidos de notificación' }).first()
    ...
    const testButton = audioContainer.getByRole('button', { name: /Probar sonido/ })
